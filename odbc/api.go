...
//sys   SQLBindCol(statementHandle syscall.Handle, columnNumber uint16, targetType CDataType, targetValuePtr uintptr, bufferLength int32, ind *SQLValueIndicator) (ret SQLReturn) = odbc32.SQLBindCol
...
//sys   SQLBindParameter(statementHandle syscall.Handle, parameterNumber uint16, inputOutputType SQLBindParameterType, valueType CDataType, parameterType SQLDataType, columnSize uint64, decimalDigits int16, parameterValue uintptr, bufferLength int, ind *SQLValueIndicator) (ret SQLReturn) = odbc32.SQLBindParameter
...
//sys   SQLColAttribute(statementHandle syscall.Handle, columnNumber uint16, fieldIdentifier SQLDescriptor, characterAttribute uintptr, bufferLength int16, stringLengthPtr *int16, numericAttributePtr *int32) (ret SQLReturn) = odbc32.SQLColAttributeW
//sys   SQLNumResultCols(statementHandle syscall.Handle, columnCount *int16)  (ret SQLReturn) = odbc32.SQLNumResultCols
//sys   SQLGetData(statementHandle syscall.Handle, colNum uint16 , targetType CDataType, targetValuePtr uintptr, bufferLength int64, ind *SQLValueIndicator) (ret SQLReturn) = odbc32.SQLGetData
